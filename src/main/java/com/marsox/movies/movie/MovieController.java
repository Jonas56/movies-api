...
public class MovieController {
    ...
    @PostMapping
    public ResponseEntity<MovieResponseDto> addNewMovie(@RequestBody @Valid Movie m) {
    ...
    @PutMapping("/{movieId}")
    public ResponseEntity<MovieResponseDto> updateMovie(@PathVariable("movieId") Long movieId, @RequestBody Movie m) {
